 ...
 */
final class Version20240723123413 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pokemon ALTER id ADD GENERATED BY DEFAULT AS IDENTITY');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pokemon ALTER id DROP IDENTITY');
